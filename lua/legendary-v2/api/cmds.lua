...
M.cmds = vim.tbl_map(function(cmd)
...
end, {
  {
    ':Legendary',
    function(opts)
      local l = require('legendary-v2')
      local filters = require('legendary-v2.filters')
  ...
  {
    ':LegendaryScratch',
    require('legendary-v2.ui.scratchpad').open,
  ...
  },
  {
    ...
    function()
      ...
      require('legendary-v2.ui.scratchpad').lua_eval_current_line()
    end,
  ...
  },
  {
    ...
    function(range)
      ...
      require('legendary-v2.ui.scratchpad').lua_eval_range(range.line1, range.line2)
    end,
  ...
  {
    ':LegendaryEvalBuf',
    require('legendary-v2.ui.scratchpad').lua_eval_buf,
