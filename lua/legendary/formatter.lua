...
function M.get_format_values(item, ephemeral_formatter)
   if ephemeral_formatter ~= nil then
      return (ephemeral_formatter)(item)
   end
...
function M.format(item, formatter)
   local values = M.get_format_values(item, formatter)
