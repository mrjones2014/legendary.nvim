...
function M.register_builtins()
   require('legendary.bindings').bind_keymaps(builtin_keymaps, 'legendary.keymap.builtin')
   require('legendary.bindings').bind_commands(builtin_commands, 'legendary.command.builtin')
end
