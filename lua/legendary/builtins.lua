local M = {
  builtins = {
    ...
    { ':e {file}', description = 'New/open file or dir', builtin = true },
    { ':sp [file]', description = 'Split open (horizontal)', builtin = true },
    { ':vs [file]', description = 'Split open (vertical)', builtin = true },
    ...
    { ':sav {filename}', description = 'Save as', builtin = true },
    ...
    { '{n}yy', description = 'Copy {n} lines', builtin = true },
    ...
    { ':bufdo {Cmd}', description = 'Run {Cmd} in all buffers', builtin = true },
    ...
    { ':set tw={n}', description = 'Set text width to {n}', builtin = true },
    { ':sort', description = 'Sort selected lines', builtin = true },
    { ':sort u', description = 'Sort+remove duplicates', builtin = true },
    { ':norm @{r}', description = 'Run macro in reg {r} for each line', builtin = true },
    ...
    { '{n}<C-a>', description = 'Increment number by {n}', builtin = true },
    { '{n}<C-x>', description = 'Decrement number by {n}', builtin = true },
    ...
    { '{n}zl', description = 'Scroll horizontally right', builtin = true },
    { '{n}zh', description = 'Scroll horizontally left', builtin = true },
    ...
    { ':setl cc={n}', description = 'Page guide at column {n}', builtin = true },
    ...
    { ':b{n}', description = 'Edit buffer {n}', builtin = true },
    ...
    { '/{P}', description = 'Search forward for {P}', builtin = true },
    { '?{P}', description = 'Search backward for {P}', builtin = true },
    ...
    { ':{n}', description = 'Go to line {n}', builtin = true },
    ...
    { ':tag [tagname]', description = 'Jump to specified tag', builtin = true },
    ...
    { ':delmarks {mark}', description = 'Remove marks', builtin = true },
    ...
    { ':windo {Cmd}', description = 'Execute {Cmd} in all windows', builtin = true },

    { ':tabnew', description = 'New untitled tab', builtin = true },
    { ':tabe [file]', description = 'New/open in tab', builtin = true },
    ...
    { ':tabdo {Cmd}', description = 'Execute {Cmd} in all tabs', builtin = true },
    ...
    { ':h [helptag]', description = 'Help', builtin = true },
    { ':helpgrep {searchterm}', description = 'Help search', builtin = true },
    { ':h hitest.vim', description = 'Help on highlight test', builtin = true },
    { ':map [mapping]', description = 'View mappings', builtin = true },
    { ':imap [mapping]', description = 'View Insert mode mappings', builtin = true },
    ...
    { ':cd {dir}', description = 'Change directory', builtin = true },
    { ':cd', description = 'Change to home directory', builtin = true },
    { ':echo {Var}', description = 'Show value of {Var}', builtin = true },
